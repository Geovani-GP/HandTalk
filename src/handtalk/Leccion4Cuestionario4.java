 ...
 * @author mafer
 */
public class Leccion4Cuestionario4 extends javax.swing.JFrame {

    /**
     * Creates new form Leccion4Cuestionario4
     */
    public Leccion4Cuestionario4() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 360, 130, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Leccion4Cuestionario4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Leccion4Cuestionario4().setVisible(true);
            }
        });
    }
