 ...
 * @author mafer
 */
public class Leccion3Cuestionario3 extends javax.swing.JFrame {

    /**
     * Creates new form Leccion3Cuestionario3
     */
    public Leccion3Cuestionario3() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("¿Que numero representa esta seña?");
        ...
        jButton4.setText("b) 1,000,000");
        jButton4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton4ActionPerformed(evt);
            }
        });
        jPanel3.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(79, 272, 130, -1));

        jButton5.setFont(new java.awt.Font("Segoe Script", 1, 12)); // NOI18N
        jButton5.setText("c) 100");
        jButton5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton5ActionPerformed(evt);
            }
        });
        jPanel3.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(79, 353, 130, -1));
        ...
        jPanel3.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 390, 220, 30));

        jLabel8.setText("jLabel8");
        jPanel3.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 170, 220, 210));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Leccion3Cuestionario3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Leccion3Cuestionario3().setVisible(true);
            }
        });
    }
